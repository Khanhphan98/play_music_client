              ...
              <Slideover.Description class="px-5 py-5 mt-3 mr-3">
                ...
                >
                  <div class="relative z-10 pt-3">
                    <div v-for='(song, idx) in favoriteSong'  @mouseover="showRecent = idx" @mouseleave="showRecent = ''" :key='song.id' class="intro-x" @click='handleFavoriteSong(song)'>
