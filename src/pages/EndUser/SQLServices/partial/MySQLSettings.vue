          ...
          <Table.Tr v-for="(k, idx) in Object.assign(initDemo)" :key="idx">
            ...
            <Table.Td class="w-8/12">
              <div v-if="k.type === 'text'">
                <div class="flex">
                  <FormInput v-model="k.val" :type="k.type" class="mr-2" />
                  <Tippy
                    :as="Button"
                    size="sm"
              ...
              <div v-else-if="k.type === 'tomselectinput'" class="flex">
              ...
              <div v-else-if="k.type === 'select'" class="flex">
                <FormSelect v-model="k.val" aria-label="Default select example" class="mr-2">
                  <option v-for="lv in 3" :key="lv" :value="lv">
              ...
              <div v-else-if="k.type === 'radio'" class="flex">
                <div class="flex flex-col mr-2 sm:flex-row mr-auto">
                  <FormCheck class="mt-2 mr-2 sm:mt-0">
                    <FormCheck.Label :html-for="idx + '_one'" class="mr-2">
                      Yes <span v-if="k.df === 1" class="text-slate-400">(default)</span>
                    </FormCheck.Label>
                    <FormCheck.Input :id="idx + '_one'" v-model="k.val" type="radio" :name="idx" value="1" />
                  </FormCheck>
                  <FormCheck class="mt-2 mr-2 sm:mt-0">
                    <FormCheck.Label :html-for="idx + '_two'" class="mr-2">
                      No <span v-if="k.df === 0" class="text-slate-400">(default)</span>
                    </FormCheck.Label>
                    <FormCheck.Input :id="idx + '_two'" v-model="k.val" type="radio" :name="idx" value="0" />
                  </FormCheck>
                </div>
                <Tippy
                  :as="Button"
