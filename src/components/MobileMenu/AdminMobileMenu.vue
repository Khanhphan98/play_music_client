<script setup lang="ts">
  ...
  import { FormattedMenu, nestedMenu, enter, leave } from '../../layouts/Admin/admin-menu';
  ...
  const sideMenuStore = useAdminMenuStore();
    ...
    <div
      ...
      <ul class="py-2">
        ...
        <template v-for="(menu, menuKey) in formattedMenu">
          <Divider v-if="menu == 'divider'" as="li" class="my-6" :key="'divider-' + menuKey"></Divider>
